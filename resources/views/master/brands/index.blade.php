                ...
                <tbody>
                    @foreach($brands as $i => $brand)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 ">
                                        <span class="px-3 py-1 text-xs font-semibold rounded-full {{ $brand->available_products_count > 0
            ...
            <form id="brandForm" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        ...
                        <input type="text" name="name" id="brandName" required class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 text-sm
