<table>
    {{-- HEADER --}}
    <tr>
        <td colspan="8" style="font-size:18px; font-weight:bold; text-align:center; padding:8px 0;">
            LAPORAN PENJUALAN
        </td>
    </tr>
    <tr>
        <td colspan="8" style="text-align:center; color:#6b7280; padding-bottom:4px;">
    ...
    <tr>
        <td colspan="3" style="padding:4px 10px; text-align:right; color:#b91c1c;">Piutang / Belum Tertagih</td>
        <td style="padding:4px 10px; text-align:right; font-weight:bold; color:#b91c1c;">- Rp
            {{ number_format($totalPiutang, 0, ',', '.') }}</td>
        <td colspan="4"></td>
    </tr>
    <tr>
        <td colspan="3" style="padding:4px 10px; text-align:right; color:#6b7280;">Kas Diterima (Penjualan)</td>
        <td style="padding:4px 10px; text-align:right; font-weight:bold;">Rp
